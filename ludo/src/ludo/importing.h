...
namespace ludo
{
  ...
  struct import_results
  {
    ...
    //std::vector<dynamic_body_shape> dynamic_body_shapes; ///< The imported dynamic body shapes. TODO
  ...
  /// \param indices The indices to import to.
  /// \param vertices The vertices to import to.
