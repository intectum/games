...
namespace ludo
{
  ...
  void test_spatial_octree()
  {
    ...
    auto octree_1 = octree { .bounds = bounds_1 };
    init(octree_1);
    ...
    for (auto cell_index = 0; cell_index < 8; cell_index++)
    {
      ...
      {
        test_equal("octree: add (cell element count)", elements.size(), std::size_t(1));
      }
      else
      {
        test_equal("octree: add (cell element count)", elements.size(), std::size_t(0));
      }
    }
    ...
    for (auto cell_index = 0; cell_index < 8; cell_index++)
    {
      ...
      if (cell_index == position_1_cell_index)
      {
        test_equal("octree: remove (cell element count)", elements.size(), std::size_t(1));
      }
      else
      {
        test_equal("octree: remove (cell element count)", elements.size(), std::size_t(0));
      }
    }
