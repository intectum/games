...
namespace ludo
{
  ...
  void test_spatial_quadtree()
  {
    ...
    auto quadtree_1 = quadtree { .bounds = bounds_1 };
    init(quadtree_1);
    ...
    for (auto cell_index = 0; cell_index < 4; cell_index++)
    {
      ...
      {
        test_equal("quadtree: add (cell element count)", elements.size(), std::size_t(1));
      }
      else
      {
        test_equal("quadtree: add (cell element count)", elements.size(), std::size_t(0));
      }
    }
    ...
    for (auto cell_index = 0; cell_index < 4; cell_index++)
    {
      ...
      if (cell_index == position_1_cell_index)
      {
        test_equal("quadtree: remove (cell element count)", elements.size(), std::size_t(1));
      }
      else
      {
        test_equal("quadtree: remove (cell element count)", elements.size(), std::size_t(0));
      }
    }
